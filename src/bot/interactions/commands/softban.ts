...
const SoftbanCommand: IFunction = {
	...
	async execute(interaction) {
		...
		if (!(await PunishmentManager.canPunish(interaction.client, PunishmentType.Softban, interaction.options.getUser(translate(Locale.EnglishGB, "MODERATION_TARGET_OPTION_NAME"), true).id, interaction.user.id, interaction.guildId))) {
