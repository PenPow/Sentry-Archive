...
By using services offered by Sentry ("we"), including but not limited to the Sentry Discord bot, this website, and our Phishertools service, you agree and consent to this policy, along with the [Privacy Policy](/docs/privacy) and the [Responsible Security Disclosure Policy](/docs/security).
