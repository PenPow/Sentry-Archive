...
export function Card({
  ...
  href,
  ...props
}: { children: React.ReactNode, title: string, icon: React.ReactNode, image: React.ReactNode, arrow: boolean, href: string  }) {
...
export function Cards({ children, num, ...props }: { children: React.ReactNode, num: number, props: any }) {
  return (
    <div
      ...
      style={
        {
          '--rows': num || 3,
		  // @ts-expect-error i cant be asked to fix this
          ...props.style
        } as any
      }
    >
